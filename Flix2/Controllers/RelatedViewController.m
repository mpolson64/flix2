...
@interface RelatedViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UISearchBarDelegate>
...
- (void)fetchMovies {
    NSString *requestString = [[@"https://api.themoviedb.org/3/movie/" stringByAppendingString:[NSString stringWithFormat:@"%@", self.movie[@"id"]]] stringByAppendingString:@"/similar?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed&language=en-US"];
